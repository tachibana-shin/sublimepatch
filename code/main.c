...
void patch_sublime() {
  ...
  fseek(crack, 0x000A7214, SEEK_SET);  // Se mueve a la dirección o numero
                                       // espacios desde el comienzo del archivo
...
void patch_merge() {
  ...
  fseek(crack, 0x00024A54, SEEK_SET);  // Se mueve a la dirección o numero
                                       // espacios desde el comienzo del archivo
...
void patch_merge() {
  ...
  fseek(crack, 0x003C6A3C, SEEK_SET);  // Se mueve a la dirección o numero
                                       // espacios desde el comienzo del archivo
  fwrite(b1, sizeof(b1[0]), 8, crack);
...
\\_______)(_______)|/ \\___/ (_______/\\_______/|/     \\|(_______/ \n \
  ...
  printf(
      "\nThanks to @leogx9r for providing cracking methods, written in C by "
      "Codigo Cristo\n");
